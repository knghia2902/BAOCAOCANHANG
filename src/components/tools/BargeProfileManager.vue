...
<template>
    <div class="flex-grow flex flex-col md:flex-row overflow-y-auto md:overflow-hidden gap-4 p-2 md:p-4 min-h-0 md:h-full bg-transparent font-display text-left justify-center">
        <!-- Details or Master Overview List -->
        <div class="flex-grow flex flex-col min-h-0 md:h-full min-w-0 max-w-[1500px] mx-auto gap-4 overflow-y-auto md:overflow-hidden">
